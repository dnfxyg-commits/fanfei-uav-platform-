          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                <p>
                  閞飞翔（FanFei）成立于深圳南山，创始团队均来自于大疆、腾讯、商汤等头部科技企业及北航、西工大等知名航空院校。
                </p>
                <p>
                  我们从成立之初就确立了“算法驱动、云端协同”的技术路线，致力于解决无人机在大规模商用化进程中面临的“高难度操作、高维保成本、低安全可靠”三大核心瓶颈。
                </p>
                <p>
                  目前，閞飞翔已在全球拥有30余个核心研发专利，业务覆盖智慧农业、城市巡检、物流配送等多个战略性新兴领域。
                </p>
              </div>
            </div>
